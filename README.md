...
### Apple Silicon Users
Make sure to use Python 3.9 if you plan to install packages with `pip`. If you decide to use `conda`, run the following to create the environment and install all the required packages:
